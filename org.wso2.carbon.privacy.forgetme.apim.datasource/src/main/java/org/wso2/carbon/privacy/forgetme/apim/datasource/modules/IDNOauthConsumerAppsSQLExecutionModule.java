...
public class IDNOauthConsumerAppsSQLExecutionModule implements Module<UserSQLQuery> {
    ...
    public IDNOauthConsumerAppsSQLExecutionModule(DataSourceConfig dataSourceConfig) throws SQLModuleException {
    ...
    public void execute(UserSQLQuery userSQLQuery) throws ModuleException {
        ...
        String query = "UPDATE IDN_OAUTH_CONSUMER_APPS SET USERNAME = `pseudonym`, APP_NAME = `modifiedAppName` "
        ...
        try (Connection connection = dataSource.getConnection()) {
            ...
            if (modifiedApplicationName != null) {
